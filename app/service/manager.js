...
exports.GM_MenuManager = require(config.serverRoot + '/manager/GM_MenuManager');
exports.GM_RoleManager = require(config.serverRoot + '/manager/GM_RoleManager');
exports.GM_UserManager = require(config.serverRoot + '/manager/GM_UserManager');
